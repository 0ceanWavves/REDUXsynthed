/**
 * ThreeJSLoader.js - Public version
 * 
 * A centralized utility for importing and configuring Three.js across the application.
 * This version uses direct CDN imports for compatibility with browser module loading.
 */
...
export async function loadThreeJS() {
  ...
  try {
    ...
    // Loading directly from CDN (most reliable method for browser modules)
    try {
